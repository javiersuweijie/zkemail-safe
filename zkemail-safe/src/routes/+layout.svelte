...
<main>
	<div class="h-screen bg-base-100">
		<!-- header -->
		<div class="w-full h-1/6 text-center text-primary-content pt-5 md:hidden bg-base-200 pl-5 pr-5">
		...
		<div class="w-full flex h-5/6 md:h-full">
			<div class="w-4/12 items-center justify-center hidden md:flex bg-base-200">
				<div class="px-8 text-left text-primary-content">
					...
					<div tabindex="0" class="collapse collapse-open" class:collapse-open={isAtStep($step, 1)} class:collapse-arrow={!isAtStep($step, 1)}> 
					...
					<div tabindex="0" class="collapse collapse-open" class:collapse-open={isAtStep($step, 2)} class:collapse-arrow={!isAtStep($step, 2)}> 
					...
					<div tabindex="0" class="collapse collapse-open" class:collapse-open={isAtStep($step, 3)} class:collapse-arrow={!isAtStep($step, 3)}> 
